...
<template>
    <div class="bg-white p-5 space-y-3 rounded-lg">
        <p class="text-gray-500 font-black text-center">
            Fecha: <span class="font-light">{{ displayDate(appointment.date) }}</span>
            Hora: <span class="font-light">{{ appointment.time }} horas</span>
        </p>

        <p class="text-gray-700 text-lg font-black">Servicios solicitados en la cita</p>
        ...
        <div class="flex gap-2 items-center">
            <button
                class="bg-slate-600 rounded-xl p-3 text-white text-sm uppercase	font-black flex-1 md:flex-none"
            >
                Editar cita
            </button>

            <button
                class="bg-red-600 rounded-xl p-3 text-white text-sm uppercase	font-black flex-1 md:flex-none"
            >
                Cancelar cita
            </button>
        </div>
